...
namespace eagle::virt::handle
{
    ...
    private:
        ...
        encode_status encode_operand(asmbl::function_container& container, const zydis_decode& instruction, zydis_dimm op_imm,
            encode_ctx& context) override;

        void upscale_temp(asmbl::function_container& container, reg_size target_size, reg_size current_size);
    };
}
