...
namespace eagle::virt::eg
{
    ...
    struct settings
    {
        ...
        */
        ...
        /**
         * when enabled, jumps generated by the vm will be concious of 64 bit addresses
         * the only use of this is for testing the virtual machine generation with 64 bit address memory allocations
         *
         * recommended value: true
         */
        bool relative_addressing = true;

        bool complex_temp_loading = true;
    };
